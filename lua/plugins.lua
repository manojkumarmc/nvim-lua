...
return require('packer').startup(function(use)
    ...
    use {
        'jiangmiao/auto-pairs', --- autoclosing (till autopairs gets any better)
        config = function()
            vim.cmd [[
    ...
    use {
        ...
        config = function()
            ...
            vim.g.indent_blankline_filetype_exclude = {
                "help", "terminal", "dashboard", "packer", "norg"
            }
    ...
    use {
        ...
        config = function()
            ...
            cmp.setup {
                ...
                sources = {
                    ...
                    {name = "nvim_lsp"}, {name = "calc"}, {name = "path"},
                    {name = "buffer"}, {name = "neorg"}, {name = "cmp_tabnine"}
                },
                formatting = {
        ...
        requires = {
            ...
            {'hrsh7th/cmp-path', after = 'nvim-cmp'}, {'L3MON4D3/LuaSnip'}
        }
    }
